...
bnb_config = BitsAndBytesConfig(
    ...
    bnb_4bit_use_double_quant=True,  # 开启双重量化，提升精度
    bnb_4bit_quant_type="nf4",  # 量化类型：nf4（适合自然语言）/fp4
    bnb_4bit_compute_dtype=torch.bfloat16,  # 计算 dtype（bfloat16/float16，匹配GPU）
)
